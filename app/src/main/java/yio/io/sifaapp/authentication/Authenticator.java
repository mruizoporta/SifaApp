...
import yio.io.sifaapp.LoginActivity;
...
public class Authenticator extends AbstractAccountAuthenticator {
    ...
    private String TAG = "SIFACAuthenticator";
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        Log.d("SIFACAuthenticator", TAG + "> addAccount");
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        Log.d("SIFACAuthenticator", TAG + "> getAuthToken");
        ...
        Log.d("SIFACAuthenticator", TAG + "> peekAuthToken returned - " + authToken);
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    Log.d("SIFACAuthenticator", TAG + "> re-authenticating with the existing password");
